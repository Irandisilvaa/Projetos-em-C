/*
Este é um programa em C que gerencia informações sobre diferentes modelos de freezers.
Ele permite visualizar uma lista de freezers com suas características,
exibir os dados de uma característica específica, exibir todos os dados
de um modelo de freezer, alterar dados de um freezer específico e encontrar
o melhor freezer em diferentes critérios, como capacidade, garantia, economia e
temperatura. O programa apresenta um menu 
interativo para o usuário selecionar as operações desejadas e utiliza uma 
estrutura de dados ModeloFreezer para armazenar as informações dos freezers.
*/
