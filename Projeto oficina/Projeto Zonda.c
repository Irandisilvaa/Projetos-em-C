/*
Este programa em C gerencia serviços de uma oficina mecânica especializada em motos.
Ele permite solicitar serviços, iniciar serviços, remover solicitações, 
consultar solicitações em aberto, concluir serviços e encerrar o expediente, calculando o valor total obtido com os serviços realizados.
O usuário interage com o programa através de um menu de opções.
Os dados das motos e dos serviços são armazenados em um vetor de estruturas. 
O programa valida as entradas do usuário e realiza as operações de acordo com as escolhas feitas.
*/
